...
{
	boxfill8(vram, x, COL8_008484,  0,     0,      x -  1, y - 29); // ×ÀÃæ
	boxfill8(vram, x, COL8_C6C6C6,  0,     y - 28, x -  1, y - 28); // ×ÀÃæÓëÈÎÎñÀ¸µÄ·Ö¸ô
	boxfill8(vram, x, COL8_FFFFFF,  0,     y - 27, x -  1, y - 27); // ×ÀÃæÓëÈÎÎñÀ¸µÄ·Ö¸ô
	boxfill8(vram, x, COL8_C6C6C6,  0,     y - 26, x -  1, y -  1); // ÈÎÎñÀ¸


	boxfill8(vram, x, COL8_FFFFFF,  3,     y - 24, 59,     y - 24); // ÏÂÃæ¶¼ÊÇ±ß¿òÑÕÉ«
